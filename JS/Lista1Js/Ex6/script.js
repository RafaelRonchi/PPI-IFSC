...
function gerar(){
    b1.style.backgroundColor = '#05668D';
    b2.style.backgroundColor = '#427AA1';
    b3.style.backgroundColor = '#EBF2FA';
    b4.style.backgroundColor = '#679436';
    b5.style.backgroundColor = '#A5BE00';
}